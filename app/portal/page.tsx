    ...
    <div className="w-full max-w-5xl mx-auto px-4 py-6 md:p-8 space-y-6 md:space-y-8 pb-24 bg-slate-50 min-h-screen">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-full bg-slate-200 border border-slate-300 text-slate-700 flex items-center justify-center font-black text-xl shadow-sm">
            {user.name.charAt(0)}
          </div>
          <div>
        ...
        <Button asChild size="icon" className="md:w-auto md:px-6 md:h-12 w-12 h-12 rounded-full md:rounded-xl bg-slate-900 text-white shadow-md">
      ...
      <div className="space-y-3">
        ...
        {nextEvent ? (
          <div className="bg-white rounded-[24px] shadow-sm border border-slate-200 overflow-hidden relative">
            {/* Subtle Top Border Accent - Orange */}
